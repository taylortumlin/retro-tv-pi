...
# Admin page now served by SPA catch-all route
...
def _startup():
    """Initial data fetch and start background refresh — works under both
    gunicorn and direct `python3 tv_guide.py`."""
...
# Run startup on import so gunicorn workers also get the refresh loop
_startup()
